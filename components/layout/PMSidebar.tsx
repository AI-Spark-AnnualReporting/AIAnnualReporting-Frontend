            ...
            return (
              ...
              >
                ...
                {item.badge === "reviews" && pendingReviews > 0 && (
                  <span className="inline-flex h-5 min-w-5 items-center justify-center rounded-md bg-white/20 px-1.5 text-[11px] font-semibold text-white">
                    {pendingReviews}
                  </span>
                )}
              </Link>
      ...
      <div className="border-t border-white/10 p-3 shrink-0">
        <div className="flex items-center gap-3 rounded-lg px-2 py-1.5">
          ...
          <div className="min-w-0 flex-1 leading-tight">
            ...
            <p className="truncate text-xs text-indigo-200">Project Manager</p>
          </div>
          <button
            onClick={logout}
            title="Sign out"
